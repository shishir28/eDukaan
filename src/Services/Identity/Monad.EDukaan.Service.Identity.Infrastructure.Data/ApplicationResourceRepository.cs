...
{
    public class ApplicationResourceRepository  : Repository<ApplicationResource>, IApplicationResourceRepository
    {
        public ApplicationResourceRepository(ApplicationDBContext dataContext) : base(dataContext) { }
    }
}